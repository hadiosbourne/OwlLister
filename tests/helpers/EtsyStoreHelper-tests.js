...
const EtsyStoreHelper = require('../../helpers/EtsyStoreHelper');
const request = require('request');

describe('EtsyStoreHelper testing scenarios', function () {
  ...
  describe('getListing test cases', function () {
     ...
     * @since  29 July 2019
     *
     * @covers helpers/EtsyStoreHelper.getListing
     */
    it('Testing the successful return of etsy record', function (done) {
      ...
      EtsyStoreHelper.getListing(limit, offset, callbackSpy);
    });
